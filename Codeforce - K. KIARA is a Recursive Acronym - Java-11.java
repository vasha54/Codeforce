// Codeforce - K. KIARA is a Recursive Acronym - Java 11

/*
Tematica: String + Busqueda binaria 
...
public class Main {
    ...
    public void solve() throws Exception {
        ...
        char [] letters =new char [nWords];
        
        String [] listWords =new String[nWords];
        
        for(int i=0;i<nWords;i++){
            listWords[i]=next();
            letters[i]=listWords[i].charAt(0);
        }
        ...
        for(int i=0;i<nWords && !find;i++){
            ...
            while(pivot < listWords[i].length() && Arrays.binarySearch(letters,listWords[i].charAt(pivot))>=0){
              checkLetters++;
              pivot++;
            }
